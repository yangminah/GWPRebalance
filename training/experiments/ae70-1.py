...
checkpoint =torch.load(f"{save_loc}{oldname}ae.h5")# None 
...
metrics=None
# del data
train_loop3([trn_yrs, tst_yr],model, loss_fn, optimizer, scheduler, metrics, train_info, funcs)
